...
namespace TiltFive
{
    ...
    public class Display : TiltFive.SingletonComponent<Display>
    {
        ...
        private bool SetApplicationInfoImpl()
        {
            ...
            // Tilt Five SDK Mod - don't load the SDK version from an asset, instead use a static value from code.
            //TextAsset pluginVersionAsset = (TextAsset)Resources.Load("pluginversion");
            string applicationVersionInfo = $"App: {productVersion}, Engine: {engineVersion}, T5 SDK: {Plugin.TiltFiveVersion}";
