...
namespace TiltFive
{
    ...
    public partial class SplitStereoCamera : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            // into the backbuffer
            // Tilt Five SDK Mod - load the shader from the plugin's own resources instead of directly from Unity.
            displayBlitShader = new Material(Plugin.Shaders[SHADER_DISPLAY_BLIT]);
            // Did we find it?
